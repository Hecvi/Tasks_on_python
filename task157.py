...
от штата голосуют в соответствии с результатами голосования внутри штата,
...
и сколько голосов было отдано данным штатом. Подведите итоги выборов: для
...
отдавших голоса за этого кандидата. Выведите фамилии всех кандидатов в
лексикографическом порядке,затем, через пробел, количество отданных за них
голосов
"""
...
with open('input.txt', encoding='utf8') as file:
    for line in file:
        surname, num = line.split()
        if surname not in myDict:
            myDict[surname] = int(num)
        else:
            myDict[surname] += int(num)
