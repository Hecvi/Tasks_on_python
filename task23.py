...
# значений двух переменных типа (a, b) = (b, a). Кстати, аналогично можно
# делать присваивания любого количества переменных. Например, ввод в этой
# задаче можно оформить так:
